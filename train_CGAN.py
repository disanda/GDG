...
# others
parser.add_argument('--experiment_name', dest='experiment_name', default='CGAN_')
...
import models.CGAN
# model
D = models.CGAN.Discriminator(x_dim=3, c_dim=c_dim, norm=norm, weight_norm=args.weight_norm).to(device)
