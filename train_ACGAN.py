...
# others
parser.add_argument('--experiment_name', dest='experiment_name', default='ACGAN_MNIST')
...
d_learning_rate = args.d_learning_rate#0.0002
g_learning_rate = args.g_learning_rate#0.001
n_d = args.n_d
